...
"left":"right",!0);break;case 27:this.s.blurable&&!0===b&&this._blur();break;case 33:case 34:c&&(a.preventDefault(),d.page(33===a.keyCode?"previous":"next").draw(!1));break;case 35:case 36:c&&(a.preventDefault(),b=d.cells({page:"current"}).indexes(),c=this._columns(),this._focus(d.cell(b[35===a.keyCode?b.length-1:c[0]]),null,!0,a));break;case 39:c&&this._shift(a,"left");break;case 38:c&&this._shift(a,"up");break;case 37:c&&this._shift(a,"right");break;case 40:c&&this._shift(a,"down");break;default:!0===
