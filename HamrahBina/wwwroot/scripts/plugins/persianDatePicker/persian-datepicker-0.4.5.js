    ...
    var ClassDatepicker = {
        ...
        _syncWithImportData: function (pasted) {
            if (pasted) {
                ...
                if (jQuery.isNumeric(pasted)) {
                    ...
                    var inval = this.inputElem.val();
                    if (inval && inval !== 'undefined') {
                        self._updateInputElement();
                    }
                } else {
        ...
        _updateInputElement: function () {
            var self = this;
                ...
                //if (self.state.selected.year !== 1348) {
        ...
        _defineOnInitState: function () {
            ...
            if ($(this.$container)[0].nodeName == 'INPUT') {
                te = this.inputElem.val();
                //todo convert to garegurian
                var t2 = moment(te,'jYYYY/jM/jD').format('M/D/YYYY');
        
                var garegurianDate = new Date(t2).valueOf();
                this.$container = $('body');
            }
            else {
            ...
            //} else {
            //    this.state.setSelectedDateTime('unix', 0);
            //    this.state.setTime('unix', this.state.unixDate);
            //    this.state.setView('unix', this.state.unixDate);
            //}
