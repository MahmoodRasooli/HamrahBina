...
namespace HamrahBina.Common.Tools
{
    public class PersianCulture : CultureInfo
    {
            ...
            : base(cultureName, useUserOverride)
        {
            ...
            Type calenderId = typeof(Calendar).Assembly.GetType("System.Globalization.CalendarId");
            ...
            var newOptionalCalendarIDs = Array.CreateInstance(calenderId, optionalCalendars.Count);
            for (int i = 0; i < newOptionalCalendarIDs.Length; i++)
            {
                var ccc = Convert.ChangeType(idProperty.GetValue(optionalCalendars[i], null), calenderId);
                newOptionalCalendarIDs.SetValue(ccc, i);
            }
